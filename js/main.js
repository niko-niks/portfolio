...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    // Modal image enlarge on hover/click
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.modal-popup img').forEach(function(img) {
        // Click to toggle enlarge
        img.addEventListener('click', function(e) {
            e.stopPropagation();
            img.classList.toggle('enlarged');
        });
        // Remove enlarge on click outside image (inside modal)
        img.closest('.modal-popup').addEventListener('click', function(e) {
            if (e.target !== img) {
